...
const Filters = () => {
    const {regions, countries,filteredCountries, setFilteredCountries} = useContext(CountriesContext)
    ...
    useEffect(() => {
        if(selectedRegion === '') {
            ...
            console.log('region filter off')
        } else {
            console.log("region filter on")
    ...
    <div className='flex justify-between items-center px-20'>
        <form action="" className='max-w-sm'>
            <div className='flex justify-between'>
                ...
                <div className='shadow-md  p-6 rounded-md relative' >
