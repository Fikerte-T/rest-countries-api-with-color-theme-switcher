    ...
    <>
        ...
        <>
            <div className='w-full md:w-[50%] lg:w-[45%]'>
                <img className='' src={country?.flags.svg || 'None'} alt="" />
            </div>
            <div className='w-full md:w-[40%] lg:w-[45%] py-10'>
                ...
                <div className='flex flex-col items-baseline space-y-10 lg:flex-row lg:justify-between lg:space-x-5 '>
                    <div className='flex flex-col space-y-2'>
                        <p className='font-semibold'>Native Name: <span className='font-light'>{country?.nativeName || 'None'}</span></p>
                        <p className='font-semibold'>Population: <span className='font-light'>{country?.population.toLocaleString() || 'None'}</span></p>
                        <p className='font-semibold'>Region: <span className='font-light'>{country?.region || 'None'}</span></p>
                        <p className='font-semibold'>Sub Region: <span className='font-light'>{country?.subregion || 'None'}</span></p>
                        <p className='font-semibold'>Capital: <span className='font-light'>{country?.capital || 'None'}</span></p>
                    </div>
                    <div className='flex flex-col space-y-2'>
                        <p className='font-semibold'>Top Level Domain: <span className='font-light'>{country?.topLevelDomain || 'None'}</span></p>
                        <p className='font-semibold'>Currencies: <span className='font-light'>{country.currencies?.[0]?.name || 'None'}</span></p>        
